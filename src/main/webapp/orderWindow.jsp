...
<main class="container">
    ...
    <div class="headContainer">
        ...
        <form action="<%=request.getContextPath()%>/getProductsController" class="searchProductContainer">
            ...
            <div class="form-group inputField">
                ...
                <input type="text" class="form-control" id="eanSearch" name="ean" aria-describedby="emailHelp"
                       placeholder="Ean">

            </div>
            <div class="form-group inputField">

                <input type="text" class="form-control" name="article" id="articleSearch" aria-describedby="emailHelp"
                       placeholder="AtrikelNummer">

            </div>
            <div class="form-group inputField">

                <input type="text" class="form-control" name="productName" id="productSearch"
                       aria-describedby="emailHelp" placeholder="ProduktNamn">
    ...
    <div id="productsContainer">
        ...
        <%//used to create products that you have searched for from Table Products
    ...
    <button class="btn btn-outline-primary  submitButton" onclick="createProductContainersInShoopingcart()">KundKorg
    </button>
